...
<div class="album pb-5 bg-light">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <a class="btn btn-success text-light pull-right" href="/posts/create">
                    Create New Post
                </a>
            </div>
            @if(count($posts) > 0)
                <div class="col-md-12 mt-2">
                    ...
                    @foreach($posts as $post)
                        <a href="/posts/{{$post->id}}" class="text-dark" style="text-decoration: none;">
                            <div class="col-md-4 px-2">
                                <div class="post-item-card card mb-2 box-shadow">
                                    <img class="card-img-top"
                                        data-src="holder.js/100px225?theme=thumb&amp;bg=55595c&amp;fg=eceeef&amp;text=Thumbnail"
                                        alt="Thumbnail [100%x225]" style="height: 15em; width: 100%; display: block;"
                                    ...
                                    <div class="card-body">
                                        <h4 class="card-text" style="line-height: 1.5em; height: 3em; overflow: hidden; "><b>{{$post->title}}</b></h4>
                                        {{-- <p class="card-text text-justify" style="font-size:0.9em ; line-height: 1.5em; height: 6em; overflow: hidden; ">
                                            {{$post->body}}  
                                        </p> --}}
                                        <hr class="my-0">
                                        <small class="text-muted">Written by <a class="text-grey" style="text-decoration:none;" href="#">XXXXX</a></small>
                                        <br>
                                        <small class="text-muted"><?php echo(date("d-F-Y, H:m", strtotime($post->created_at))); ?></small>
                                    </div>
                                </div>
                            </div>
                        </a>
